return { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
        ...
        vim.keymap.set('n', '<leader>fr', builtin.resume, { desc = '[F]inding [R]esume' })
        vim.keymap.set('n', '<leader>f.', builtin.oldfiles, { desc = '[F]ind [R]ecent Files ("." for repeat)' })
